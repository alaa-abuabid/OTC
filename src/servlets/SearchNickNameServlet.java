...
public class SearchNickNameServlet extends HttpServlet {
	 ...
	 * get nickname of user and search in db for the channels where the user is subscribed to 
	 * @return HttpServletResponse response 
	 * return boolean result and ArrayList<PublicChannel> ChannelNames (SearchResponse);
	 * if any channel was found puts it in ChannelNames and sets result to true
